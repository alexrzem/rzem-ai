...
export const getPositionIn = (el: HTMLElement, defaultOffset: number, defaultTriggerPlacement: TriggerPlacement): number => {
    ...
    const additionalOffset = Number(getInlineOption(el, 'offset', inlinetriggerPlacement ? 0 : defaultOffset));
