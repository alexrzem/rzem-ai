		...
		<div v-if="prompt" class="px-4 py-4 bg-zinc-200 text-base flex-shrink">
			...
			<div class="px-2 pt-2 gap-2 flex">
				<div class="prompt-seed" @click="copySeed">
					<div><span class="prompt-seed-type">Seed</span>: <span class="prompt-seed-value">{{ seed }}</span>
					</div>
				</div>
				<div class="prompt-steps" @click="copySteps">
					<div><span class="prompt-steps-type">Steps</span>: <span class="prompt-steps-value">{{ steps
							}}</span></div>
				</div>
