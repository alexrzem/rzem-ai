...
// ------------------------------------------------------------
// RZEM.AI — Design A "Neon Synth" — Lesson Page Example
// Page: https://rzem.ai/#/flux101/lesson1
// ------------------------------------------------------------

export default function Flux101Lesson1Neon() {
  return (
    ...
    <header className="sticky top-0 z-50 backdrop-blur supports-[backdrop-filter]:bg-zinc-950/60 bg-zinc-950/80 border-b border-zinc-800">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        <div className="flex items-center gap-2">
          <div className="h-8 w-8 rounded-xl bg-gradient-to-br from-fuchsia-500 via-violet-500 to-cyan-400" />
