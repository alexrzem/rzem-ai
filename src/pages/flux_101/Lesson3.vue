<template>
    <header class="relative bg-zinc-100 shadow-sm">
        <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-gray-900">Lesson 3: Technical Deep Dive into FLUX
                Technology</h1>
    ...
    <main>
        ...
        <div class="content">
            ...
            <p>This session provides an in-depth exploration of FLUX.1’s underlying technology, architecture, and
                technical parameters, giving participants the knowledge to optimize their image generation workflow.</p>
            ...
            <h3 id="part-1-flux-architecture-training">Part 1: FLUX Architecture &amp; Training</h3>
            ...
            <ul class="list">
                <li><strong>Rectified Flow Models</strong>: Next-generation approach beyond traditional diffusion</li>
                <li><strong>Improved Training Efficiency</strong>: Faster convergence and better quality</li>
                <li><strong>Enhanced Text Understanding</strong>: Superior natural language processing</li>
                <li><strong>Multimodal Training</strong>: Trained on diverse, high-quality datasets</li>
            </ul>
            ...
            <ul class="list">
                <li><strong>Traditional</strong>: Artist starts with blank canvas, adds elements</li>
                <li><strong>Diffusion</strong>: AI starts with noise, gradually removes it to reveal image</li>
            </ul>
            <p><strong>The Diffusion Process Step-by-Step</strong>:</p>
            <ol type="1">
                <li><strong>Forward Process (Training)</strong>: Clean image → Add noise gradually → Pure noise</li>
                <li><strong>Reverse Process (Generation)</strong>: Pure noise → Remove noise gradually → Clean image
                </li>
                <li><strong>Guidance</strong>: Text prompt guides the denoising direction</li>
            </ol>
            <p><strong>Visual Analogy</strong>:</p>
            <p>Think of it like developing a photograph in a darkroom, but in reverse - starting with a completely
                developed (noisy) image and gradually revealing the true picture underneath.</p>
            <h4 id="flux.1-technical-innovations">FLUX.1 Technical Innovations</h4>
            <p><strong>Rectified Flow Architecture</strong></p>
            <ul class="list">
                <li><strong>Linear Paths</strong>: More direct routes from noise to image</li>
                <li><strong>Fewer Steps</strong>: Higher quality with fewer inference steps</li>
                <li><strong>Stability</strong>: More consistent results across different prompts</li>
            </ul>
            <p><strong>Advanced Attention Mechanisms</strong></p>
            <ul class="list">
                <li><strong>Cross-Attention</strong>: How text and image information interact</li>
                <li><strong>Self-Attention</strong>: How different parts of the image relate to each other</li>
                <li><strong>Temporal Attention</strong>: Consistency across generation steps</li>
            </ul>
            <p><strong>Training Dataset Characteristics</strong></p>
            <ul class="list">
                <li><strong>Size</strong>: Billions of high-quality image-text pairs</li>
                <li><strong>Quality Filtering</strong>: Rigorous curation for aesthetic and technical quality</li>
                <li><strong>Diversity</strong>: Wide range of styles, subjects, and compositions</li>
                <li><strong>Text Quality</strong>: Detailed, accurate descriptions</li>
            </ul>
            <h3 id="part-2-model-parameters-deep-dive">Part 2: Model Parameters Deep Dive</h3>
            ...
            <ul class="list">
                ...
                <li><strong>Default</strong>: 28 for FLUX.1 [dev], 25 for FLUX.1 [pro]</li>
                <li><strong>Impact</strong>: Quality vs. speed trade-off</li>
                <li><strong>Optimization</strong>: Find sweet spot for your use case</li>
            </ul>
            ...
            <ul class="list">
                ...
                <li><strong>Low values (1-4)</strong>: More creative, less adherent to prompt</li>
                <li><strong>Medium values (5-10)</strong>: Balanced creativity and adherence</li>
                <li><strong>High values (11-20)</strong>: Strict prompt following, potential artifacts</li>
            </ul>
            ...
            <ul class="list">
                <li>
                    <strong>Standard Resolutions</strong>:
                    <ul class="list">
                ...
                <li>
                    <strong>Popular Aspect Ratios</strong>:
                    <ul class="list">
                        <li><strong>9:16</strong> ( <code>576x1024</code> ) - Mobile, vertical content</li>
                        <li><strong>3:4</strong> ( <code>768x1024</code> ) - Classic photography</li>
                        <li><strong>1:1</strong> ( <code>1024x1024</code> ) - Social media, portraits</li>
                        <li><strong>4:3</strong> ( <code>1024x768</code> ) - Classic photography</li>
                        <li><strong>16:9</strong> ( <code>1024x576</code> ) - Widescreen, landscapes</li>
                    </ul>
                </li>
            </ul>
            ...
            <ul class="list">
                ...
                <li><strong>DDIM</strong>: Deterministic, good for consistent results</li>
                <li><strong>Heun</strong>: High quality, balanced speed</li>
            </ul>
            <p><strong>Model Precision</strong></p>
            <ul class="list">
                <li><strong>FP16</strong>: Faster, uses less memory, slight quality trade-off</li>
            ...
            <h3 id="part-3-hardware-requirements-optimization">Part 3: Hardware Requirements &amp; Optimization</h3>
            ...
            <ul class="list">
                <li><strong>Batch Size</strong>: Start with 1, increase if memory allows</li>
                <li><strong>Precision Settings</strong>: Use FP16 for memory savings</li>
            ...
            <ul class="list">
                ...
                <li><strong>Resolution Scaling</strong>: Start small, upscale if needed</li>
                <li><strong>Model Variants</strong>: Choose appropriate model for task</li>
                <li><strong>Hardware Acceleration</strong>: Proper GPU utilization</li>
            </ul>
            <p><strong>Quality vs. Performance Balance</strong></p>
            <ul class="list">
                <li><strong>Preview Workflow</strong>: Low steps for iteration, high steps for final</li>
                <li><strong>Batch Processing</strong>: Generate multiple variations efficiently</li>
                <li><strong>Parameter Presets</strong>: Save optimal settings for different use cases</li>
            </ul>
            <h3 id="part-4-troubleshooting-best-practices">Part 4: Troubleshooting &amp; Best Practices</h3>
            ...
            <ul class="list">
                <li><strong>Symptoms</strong>: Wildly different outputs with same prompt</li>
                <li>
                    <strong>Solutions</strong>:
                    <ul class="list">
            ...
            <ul class="list">
                ...
                <li><strong>Technique</strong>: Use parentheses for emphasis: “(detailed face)”</li>
            </ul>
            ...
            <ul class="list">
                ...
                <li><strong>Technique</strong>: Use style weights and clear style descriptors</li>
            </ul>
            <p><strong>Text Rendering Problems</strong></p>
            <ul class="list">
                <li><strong>Problem</strong>: Garbled or incorrect text in images</li>
                <li><strong>Solution</strong>: Use FLUX’s superior text capabilities</li>
                <li><strong>Technique</strong>: Put text in quotes: “text: ‘Hello World’”</li>
            </ul>
            ...
            <h3 id="part-5-hands-on-technical-exercises">Part 5: Hands-On Technical Exercises</h3>
            <p><em>35 minutes</em></p>
            <h4 id="exercise-1-parameter-experimentation">Exercise 1: Parameter Experimentation</h4>
            <p><strong>Objective</strong>: Understand parameter impact on results</p>
            <p><strong>Base Prompt</strong>: “Portrait of a renaissance nobleman, oil painting style”</p>
            <p><strong>Variations to Test</strong>:</p>
            <ol type="1">
                <li><strong>Steps</strong>: <code>10</code>, <code>25</code>, <code>50</code> (same seed)</li>
                <li><strong>Guidance</strong>: <code>3</code>, <code>7</code>, <code>12</code> (same seed)</li>
                <li><strong>Resolution</strong>: <code>512x512</code>, <code>768x768</code>, <code>1024x1024</code></li>
            ...
            <h4 id="exercise-2-hardware-optimization-challenge">Exercise 2: Hardware Optimization Challenge</h4>
            <p><strong>Objective</strong>: Find optimal settings for your hardware</p>
            ...
            <h4 id="exercise-3-troubleshooting-scenarios">Exercise 3: Troubleshooting Scenarios</h4>
            ...
            <ol type="1">
                ...
                <li><strong>Consistency Needs</strong>: Maintain style across series</li>
            </ol>
            <h3 id="wrap-up-next-session-preview-10-minutes">Wrap-up &amp; Next Session Preview (10 minutes)</h3>
            ...
            <h2 id="resources-for-technical-learning">Resources for Technical Learning</h2>
            <ul class="list">
